...
namespace RCA_StudyManagementSystem.Client.Utilities
{
    public class CheckDNC
    {
        ...
        public static async Task<bool> DoesDNCMatchAsync(string lastName, string firstName, DateTime? dob, string ssn)
        {
            ...
            var patients = await _dncData.ListDoNotContactsAsync(token);
