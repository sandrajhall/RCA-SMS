...
namespace RCA_StudyManagementSystem.Client.Pages.Studies
{
    public partial class List : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            Studies = await StudyData.ListUnarchivedStudiesAsync();
        ...
        async Task<IDialogReference> ViewItem(Study study)
        {
            ...
            var parameters = new DialogParameters<ViewDialog> { { x => x.Study, study } };
            ...
            return await DialogService.ShowAsync<ViewDialog>("Study View", parameters, options);
