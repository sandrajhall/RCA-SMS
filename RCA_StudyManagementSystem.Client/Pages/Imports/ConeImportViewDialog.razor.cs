...
{
    public partial class ConeImportViewDialog : ComponentBase
    {
        [CascadingParameter]
        ...
        [Parameter]
        public List<ConeImportView> CarouselRecords { get; set; } = new List<ConeImportView>(); // Receives the filtered items
        [Parameter]
        ...
        private async Task UpdateDisplayedRecords()
        {
            ...
            Model = displayedRecords.FirstOrDefault() ?? new ConeImportView();
