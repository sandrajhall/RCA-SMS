...
{
    public partial class DukeImportViewDialog : ComponentBase
    {
        [CascadingParameter]
        ...
        [Parameter]
        public DukeImportView Model { get; set; } = new DukeImportView();
        ...
        [Parameter]
        public List<DukeImportView> CarouselRecords { get; set; } = new List<DukeImportView>(); // Receives the filtered items
        [Parameter]
        ...
        private List<DukeImportView> displayedRecords = new List<DukeImportView>();
        ...
        private async Task UpdateDisplayedRecords()
        {
            ...
            Model = displayedRecords.FirstOrDefault() ?? new DukeImportView();
