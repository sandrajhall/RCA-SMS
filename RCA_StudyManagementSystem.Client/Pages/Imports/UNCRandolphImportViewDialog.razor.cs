...
{
    public partial class UNCRandolphImportViewDialog : ComponentBase
    {
        [CascadingParameter]
        ...
        [Parameter]
        public List<UNCRandolphImportView> CarouselRecords { get; set; } = new List<UNCRandolphImportView>(); // Receives the filtered items
        [Parameter]
        ...
        private async Task UpdateDisplayedRecords()
        {
            ...
            Model = displayedRecords.FirstOrDefault() ?? new UNCRandolphImportView();
